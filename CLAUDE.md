...
- Claude-specific stop hooks are optional local reminders, not canonical guardrails.
## Stop-Hook (Optional)
...
1. **Intent**: What is the user actually trying to achieve? (Not what they said — what they mean)
