...
gateway. If those pieces are absent, AgenticOS still supports normal MCP project
resolution and switching.

For the Discord MVP, configure the Hermes-side gateway and Discord separately,
then verify:
