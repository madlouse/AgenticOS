...
const PROJECT_SPECIFIC_FIELDS_PROJECT_YAML = new Set([
  ...
  'source_control.repository', 'source_control.repository.provider',
  'source_control.repository.remote', 'source_control.repository.slug',
  'source_control.repository.default_base_branch', 'source_control.repository.review_system',
